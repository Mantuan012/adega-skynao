              ...
              {isDono && (
                <div className="botoes-acao-admin">
                  {pedido.status === 'Em Preparo' && (
                    <button onClick={() => atualizarStatus(pedido.id, 'Saiu para Entrega')} className="btn-acao-admin btn-rota">
                      {/* Nota: Troquei para o ícone de despachar/preparo se necessário, mas mantive a classe de ação padrão */}
                      Despachar
                    </button>
                  )}
